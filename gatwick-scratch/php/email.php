...
define('EMAIL_ADMIN_SUBJECT', 'Feedback letter from contacts form on Gatwick');
define('EMAIL_CLIENT_SUBJECT', 'Feedback letter from Gatwick');
...
<body>
	{$name_text}
	You sent a message to Gatwick administrators at {$datetime}.<br/><br/>
